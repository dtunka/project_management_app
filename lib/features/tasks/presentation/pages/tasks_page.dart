...
class _TasksPageState extends State<TasksPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Only manager can access tasks page
    if (userRole != 'manager') {
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text('Only Project Managers can access this page.', style: TextStyle(color: Colors.grey)),
          ],
        ),
      );
    }
              ...
              Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text('Tasks', style: TextStyle(fontSize: 14, color: Colors.grey[600])),
